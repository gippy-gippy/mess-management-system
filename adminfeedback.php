...
<body>
     <div id="back">
     <h2><u><a href="adminhome1.php">Back To Home</a></u></h2>
     </div>
    <div id="op">
				...
				<ul class="acc" id="nested">
					<li>
						...
						<div class="acc-section">
							<div class="acc-content">
							 <?php
                            $r1 = "SELECT * FROM feedback WHERE fid='1'";
                            ...
                            echo "<p><h2>Quality & hygiene : ".rateit($q1)."</h2></p>" ;
					...
					<li>
						...
						<div class="acc-section">
							<div class="acc-content">
								<?php
                            $r2 = "SELECT * FROM feedback WHERE fid='2'";
                            ...
                            echo "<p><h2>Quality & hygiene :".rateit($q4)."</h2></p>" ;
					...
					<li>
						...
						<div class="acc-section">
                            ...
                            echo "<p><h2>Nutrition :".rateit($q8)."</h2></p>" ;
